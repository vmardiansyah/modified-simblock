...
public class MiningTask extends AbstractMintingTask {
	...
	public MiningTask(Node minter, long interval, int Noncenya, BigInteger difficulty) {
...
//		ProofOfWorkBlock createdBlock = new ProofOfWorkBlock((ProofOfWorkBlock)this.getParent(), this.getMinter(), getCurrentTime(), getNoncenya(), this.difficulty);
		ProofOfWorkBlock createdBlock = new ProofOfWorkBlock((ProofOfWorkBlock)this.getParent(), this.getMinter(), getCurrentTime(), getNoncenya(), this.difficulty); // Modification By Viddi
